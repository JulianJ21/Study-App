...
with tab3:
    ...
    if st.session_state.waiting:
        ...
        if st.button("Nächste Frage"):
            ...
            st.session_state.waiting = True
modules.append({
    "title": "26. Klausurfragen & Musterlösungen (SS23, SoSe23, SS25)",
    "core_insight": "Volle Klausurpraxis: echte Fragen aus allen drei Jahrgängen inklusive Lösungen.",
    "content": '''
📘 SS23 – Offene Fragen

• Welche Segmentierungskriterien würden Sie für einen Bio-Lebensmittelanbieter anwenden?
→ Psychografisch, Verhaltensorientiert, Demografisch

• Welche Preisstrategie würden Sie für ein neues innovatives Produkt wählen?
→ Skimming-Strategie (Abschöpfung)

• Nennen Sie zwei Maßnahmen im Rahmen eines Relaunchs.
→ Verpackungsänderung, neue Kommunikation, Produktverbesserung

• Welche Kommunikationsinstrumente sind für ein erklärungsbedürftiges B2B-Produkt geeignet?
→ Persönlicher Verkauf, PR, Messe

---

📘 SoSe23 – Aufgaben & Lösungen

• Nennen Sie drei Ziele der Kommunikationspolitik.
→ Bekanntheit, Einstellung, Verhalten

• Beschreiben Sie das AIDA-Modell anhand eines Beispiels.
→ Attention → Interest → Desire → Action (Beispiel: Autowerbung)

• Berechnen Sie Preiselastizität bei 10 % Preisänderung & 15 % Absatzänderung.
→ –1,5

• Werbekosten: 2.000 €, Reichweite: 50.000. Berechne TKP.
→ 40 €

• Zwei Verfahren zur Werbeerfolgskontrolle?
→ Recall-Test, Recognition-Test

• Drei Vorteile von Online-Marketing?
→ Zielgruppenfokus, Interaktivität, Messbarkeit

---

📘 SS25 – Vollständige Aufgaben (Auswahl)

• Beschreibe „Elaboration“ + skizziere das ELM.
→ Verarbeitungstiefe von Infos; zentrale & periphere Route

• Was ist ein Buying Center? Nenne drei Rollen.
→ Gedankliche Kaufgruppe; Initiator, Entscheider, Gatekeeper

• Strategieentwicklung Schritte + Beispiel.
→ Analyse – Alternativen – Bewertung – Auswahl – Umsetzung

• Plattformtypen ins Koordinatensystem einordnen.
→ Forum Maker, Matchmaker, Enabler, Hub

• Preiselastizität bei p = 20 für x(p) = 1000 – 40p
→ –4 (überproportional elastisch)

• Gewinnmaximaler Preis berechnen:
→ 0,78 €

• Unterschied Brutto- vs. Nettoreichweite
→ Brutto = Kontakte, Netto = Personen

• Bruttoreichweite berechnen:
→ 45,6 Mio (aus Summe der Multiplikationen)

• Vertriebsentscheidung & Key Account Auswahl:
→ Produkt-/Abnehmerbezogen & Potenzial / Know-how

• Zufriedenheit/Layouttest & Schätzfunktion?
→ Online-Befragung, A/B-Test, Regressionsgüte gering

---

📊 SS25 – Multiple-Choice (Auswahl)

• Welche Umfeldfaktoren des Konsumentenverhaltens?
→ Physisch, Sozial, Kulturell ✅

• Was stimmt zu Emotion & Motivation?
→ Emotion = körperlich, Motivation = Zielorientierung ✅

• Warum ist High/Low-Involvement wichtig?
→ Einfluss auf Informationsbedarf ✅

• Was kennzeichnet Zielgruppenmarketing?
→ Auswahl Zielgruppe & Positionierung ✅

• Push vs. Pull: Aussagen?
→ Pull = Werbedruck beim Kunden ✅

• Preispsychologie: Was zählt dazu?
→ Schwellenpreise, Preisanker ✅

• Positionierungsstrategien:
→ Qualitätsführer, Preisführer ✅

• Elaboration Likelihood Model:
→ Zentrale vs. periphere Route ✅

• Werbebudget verteilen:
→ 50 % TV, 30 % Online, 20 % Print → 5.000/3.000/2.000 €

• TKP-Rechnung:
→ 40 €
    ''',
    "story": "Alle drei Jahrgänge auf einen Blick: Wenn du diese Fragen verinnerlichst, bist du klausurfest. Die Mischung aus Theorie, Rechnen und Anwendung zeigt dir genau, wie du denken musst."
})